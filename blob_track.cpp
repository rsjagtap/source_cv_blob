...
//	char fileName[100] = "//home//rohit//Desktop//MyExperiments//a13.mp4";
 char fileName[100] = "//home//rohit//Desktop//CV_BLOB_Examples//OpenCV_3_Car_Counting//CarsDrivingUnderBridge.mp4";
	...
	stream1.read(frame);
	int intHorizontalLinePosition = (int)round((double)frame.rows * 0.35);
	...
	while (true) {   
		...
		Size s = resize_blur_Img.size();
		//int rows = s.height;
		//int col = s.width;

		//int cols = s.width;
		line(resize_blur_Img,Point(0,s.width/3), Point(s.height,s.width/3),Scalar( 255,0 , 0 ),1,8,0);
